    ...
    class Program
    {
...

        {
            ...
            /* Game game = new TwentyOneGame(); *//* Step 121. This instantiation does not throw an error. It's 
             ...
             order object, "Game". By higher order, TwentyOneGame inherits from "Game". The purpose of polymorphism is to
             incorporate several different objects (in this case, card games like poker) into the list, even though
             they are technically different data types.*/
            ...
            //    /* Card cardOne = new Card();*/ /*Creating (or initializing) a new card object here. You need to create 
            //      a class first, before creating your object in your main program.*/
            //                                    //cardOne.Face = "Queen"; /*Assigning values to the card.*/
            //                                    //cardOne.Suit = "Spades";
            //                                    //Card cardTwo = new Card() { Face = "King", Suit = "Diamonds" }; /*Here's a similar thing as above, but not 
            //                                    //as much typing. Similiar to how you initialize a list or array*/
